/* $Id: rx_globs.h,v 1.1.1.1 2008/03/22 16:58:37 ahltorp Exp $ */
...
/* Basic socket for client requests; other sockets (for receiving
 * server requests) are in the service structures */

EXT osi_socket rx_socket;

/* socket for icmp messages */
EXT osi_socket rx_socket_icmp;
