/* $Id: rx.h,v 1.1.1.1 2008/03/22 16:58:37 ahltorp Exp $ */
...
void		rxi_KillConnection(uint32_t host, u_short);
struct rx_call *
...
ssize_t		rx_Write(struct rx_call *, const void *, size_t);
ssize_t		rx_Read(struct rx_call *, void *, size_t);
