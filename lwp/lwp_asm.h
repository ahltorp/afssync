...
/* $Id: lwp_asm.h,v 1.1.1.1 2008/03/22 16:58:37 ahltorp Exp $ */ 
...
#endif
#endif
#if defined(powerpc) || defined(ppc) || defined(powerc) || defined(__POWERPC__)
    char *linkRegister;		/* the contents of the link register */
    long conditionRegister;	/* the contents of the condition register */
#endif /* defined(powerpc) || defined(ppc) || defined(powerc) || defined(__POWERPC__) */
};
